...
<img src="./image-20191214174243537.png" alt="image-20191214174243537" style="zoom:50%;" />

这份测试文件虽然短，但是基本包含了常见几种要素：标题、正文、图片、表格、代码、公式。下面让我们看看知乎支持的几种上传方式的效果：

### 1. 直接复制Typora中的内容到知乎编辑器

<img src="./image-20191214174118623.png" alt="image-20191214174118623" style="zoom:50%;" />
...
<img src="./image-20191214174529632.png" alt="image-20191214174529632" style="zoom:33%;" />

<img src="./image-20191214174506716.png" alt="image-20191214174506716" style="zoom:33%;" />

导入刚才我们看到的测试文件原档的效果是这样的：

<img src="./image-20191214174704023.png" alt="image-20191214174704023" style="zoom:50%;" />
...
<img src="./image-20191214175626414.png" alt="image-20191214175626414" style="zoom:50%;" />
...
<img src="./image-20191214180048117.png" alt="image-20191214180048117" style="zoom:50%;" />
...
<img src="./image-20191214221536561.png" alt="image-20191214221536561" style="zoom:50%;" />
...
<img src="./image-20191214221339326.png" alt="image-20191214221339326" style="zoom:50%;" />
...
<img src="./image-20191214213407292.png" alt="image-20191214213407292" style="zoom:50%;" />
